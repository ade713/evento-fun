      ...
      <section className="relative overflow-hidden flex justify-center items-center py-14 md:py-20">
        ...
        <div className="z-1 relative flex flex-col gap-6 lg:gap-x-16 lg:flex-row">
          ...
          <div className="flex flex-col">
            ...
            <button className="bg-white/20 text-lg capitalize mt-5 lg:mt-auto w-[95vw] rounded-md border-2 border-white/10 bg-blur sm:w-full py-2 hover:scale-105 focus:scale-105 active:scale-[1.02] transition">
              Get Tickets
            </button>
          </div>
        </div>
